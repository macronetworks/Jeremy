...
<html lang="en">
    <head>
        ...
        <%    ArrayList<Professor> profList = (ArrayList<Professor>) session.getAttribute("profList");
            ...
            ModuleFeedback f1 = new ModuleFeedback("superman", "1/1/2014", "IS101", 2011, 2012, 1, "This module has allowed me to learn alot about the technology that companies used, as well as give us insights on how companies deal with existing problems.", 1.7, 2.4, 3.8, 4.3);
            ModuleFeedback f2 = new ModuleFeedback("batman", "3/1/2014", "IS101", 2011, 2012, 2, "Love this mod! Slack ttm!", 2.8, 2.9, 3.4, 4.4);
            ModuleFeedback f3 = new ModuleFeedback("invisible woman", "5/1/2014", "IS101", 2011, 2012, 1, "soso", 3.8, 2.5, 3.8, 1.4);
            ModuleFeedback f4 = new ModuleFeedback("iron man", "7/1/2014", "IS101", 2012, 2013, 2, "ok la", 4.7, 2.7, 3.2, 4.6);
            ModuleFeedback f5 = new ModuleFeedback("spiderman", "8/1/2014", "IS101", 2012, 2013, 1, "sigh", 3.2, 4.2, 3.9, 4.4);
            ModuleFeedback f6 = new ModuleFeedback("hulk", "10/1/2014", "IS101", 2011, 2012, 2, "what the", 2.4, 4.4, 3.2, 4.8);
            ...
            ProfessorModule p2 = new ProfessorModule("Narayan RAMASUBBU", "IS101", "Information System Management", 2011, 2012, 1);
            ProfessorModule p3 = new ProfessorModule("Jason WOODARD", "IS101", "Information System Management", 2011, 2012, 1);
            ...
            AveProfRating a2 = new AveProfRating("IS101", "Narayan RAMASUBBU", 4.0, 4.4, 3.8, 4.8, 6, 10, 2, 5, 14, 1, 2, 0, 0, 0, 0, 0);
            AveProfRating a3 = new AveProfRating("IS101", "Jason WOODARD", 3.7, 4.6, 4.2, 4.4, 2, 8, 5, 9, 12, 4, 3, 2, 0, 0, 0, 0);
