...
<%
    ...
    String moduleName = (String)request.getParameter("profName");
    
    ModuleFeedback f1 = new ModuleFeedback("Tarzan","1/1/2013","IS101",2011,2012,1,"Very helpful prof and is extremely proficient in what he is teaching! He has made me learn to love IS mods!",1.7,2.4,3.8,4.3);
    ModuleFeedback f2 = new ModuleFeedback("Wonderwoman","3/1/2013","IS101",2011,2012,2,"Love his smile!",2.8,2.9,3.4,4.4);
    ModuleFeedback f3 = new ModuleFeedback("Hulk","5/1/2013","IS101",2011,2012,1,"Love enjoying going to his lesson. He makes classpart so enjoyable! And best of all, pple cant hog air time!",3.8,2.5,3.8,1.4);
    ModuleFeedback f4 = new ModuleFeedback("Ben Ten","7/1/2011","IS202",2012,2013,2,"ok la",4.7,2.7,3.2,4.6);
    ModuleFeedback f5 = new ModuleFeedback("Boom","8/1/2010","IS101",2012,2013,1,"sigh",3.2,4.2,3.9,4.4);
    ModuleFeedback f6 = new ModuleFeedback("ben6","10/1/2010","IS306",2011,2012,2,"what the",2.4,4.4,3.2,4.8);
    ...
    ProfessorModule p1 = new ProfessorModule("Richard DAVIS","IS101","Information System Management",2011,2012,1);
    ProfessorModule p2 = new ProfessorModule("Richard DAVIS","IS202","IS Software Foundation",2011,2012,1);
    ProfessorModule p3 = new ProfessorModule("Richard DAVIS","IS306","Interaction Design and Prototyping",2011,2012,1);
    ...
    AveProfRating a1 = new AveProfRating("IS101","Richard DAVIS",3.5,4.2,4.7,4.5,3,7,7,10,11,6,2,1,0,0,0,0);
    AveProfRating a2 = new AveProfRating("IS202","Richard DAVIS",4.0,4.4,3.8,4.8,6,10,2,5,14,1,2,0,0,0,0,0);
    AveProfRating a3 = new AveProfRating("IS306","Richard DAVIS",3.7,4.6,4.2,4.4,2,8,5,9,12,4,3,2,0,0,0,0);
	...
	function drawDashboard() {
		$(function() {
			...
			$.get("data2.csv", function(csvString) {
				...
				data.addColumn('number', 'Helpfulness');
				data.addColumn('number', 'Clarity');
			...
			<!-- Chart -->
				...
				<form>
					...
					<table class="table table-bordered" style="table-layout: fixed">
						...
						<tr>
                                                    <td><b>Clarity:</b></td>
							<td><input type="radio" name="easiness" value="1"> 1<br>Very Bad</td>
							...
							<td><input type="radio" name="easiness" value="5"> 5<br>Very Good</td>
						</tr>
						<tr>
                                                    <td><b>Relevance:</b></td>
                                ...
                                <%
                                    if (profModuleList.isEmpty() == true || profModuleList.size() == 0){
                                        ...
                                        for (int i =0; i<size; i++){
                                            ...
                                            <tr>
                                                <td><br> <br> <font size="4"><center><% out.println(temp1.getModuleID()); %></center></td>
                        <td>
...
Aenean lacinia bibendum nulla sed consectetur. Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Donec sed odio dui. Donec ullamcorper nulla non metus auctor fringilla.
							...
							<br> <br>
                                                        <a href="profile.jsp?moduleName=IS101"><button type="button" class="btn btn-default">Module Profile
								</button></a>
							<br> <br>
						</center>                            
                                    ...
                                    if (moduleFeedbackList.isEmpty()==true || moduleFeedbackList.size() == 0){
                                        ...
                                        for (int i=0; i<moduleFeedbackList.size(); i++){
                                            ...
                                            <tr>
                                                ...
                                                <center><b><% out.println(temp1.getCourse()); %></b></center><br>
                                                <center><% out.println(temp1.getYearTaken1()+ " - " + temp1.getYearTaken2()); %></center>
 ...
 <script type="text/javascript">
	var clicks = document.getElementById('clicked').value;
	function linkClick(){
	...
	function minusClick(){
	    ...
	    Comment Score: <input id="clicked" size="3" onfocus="this.blur();" value="<%=Math.round(Math.random()*100-50) %>" >                                               
        <button class="btn btn-default btn-sm" id="plus" href="#" onclick="linkClick()">
    <img src="thumbsup.png" alt="Smiley face" width="12" height="12">
                        </button> 
	<button class="btn btn-default btn-sm" id="minus" href="#" onclick="minusClick()">
